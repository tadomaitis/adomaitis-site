...
const AboutUs = () => (
  ...
  >
    ...
    <div className='md:w-4/5 lg:w-3/5 grid card rounded-box place-items-center pl-8 mx-auto'>
      <p className='mb-2'>
        A AC Consultoria nasceu em 2018 com o objetivo de auxiliar o
        empreendedor na gestão do seu negócio através de métodos e modelos de
        gestão utilizados no mercado.
      </p>
      <p className='mb-2'>
        A AC Consultira tem como diferencial aplicar modelos de gestão
      ...
      <p>
        A <strong>InovaMeta</strong> é o time tecnologico da Adomaitis
        Consultoria, nasceu para Apoiar empreendedores com soluções inovadoras e
        de baixo custo levando para o seu negócio agilidade, produtividade e
        redução de custos.
      </p>
    </div>
  </section>
